...
public class ProfileQuestionsFragment extends BaseFragment implements IQuestionOperationsListener, ISendingMessagesListener, IReportItemListener, IAddAnswer {
    ...
    public static ProfileQuestionsFragment newInstance(String user_id) {
...
//        mCustomLoadingDialog = new CustomLoadingDialog(mContext);
        ...
        loadQuestions(Constants.profileQuestionUrl);
    }
    ...
    private void parseQuestionsResponse(String response) {
        try {
            ...
            if (questionsList.isEmpty()) {
                ...
                noDataTextView.setText("لا يوجد أسئلة");
            } else {
